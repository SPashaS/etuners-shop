...
(() => {
  "use strict";
  const e = {},
    t = document.querySelectorAll(".menu__toggle");
  t &&
    t.forEach((e) => {
      e.addEventListener("click", () => {
        const t = e.closest(".menu__item");
        document.querySelectorAll(".menu__item.submenu-open").forEach((e) => {
          e !== t && e.classList.remove("submenu-open");
        }),
          t && t.classList.toggle("submenu-open");
      });
    });
  ...
  s &&
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      e.forEach((t) => {
        const s = t.querySelector("[data-select-trigger]"),
          i =
            (t.querySelector("[data-select-options]"),
            t.querySelectorAll(".custom-select__option"));
        s.addEventListener("click", (s) => {
          e.forEach((e) => {
            e !== t && e.classList.remove("custom-select--open");
          }),
            t.classList.toggle("custom-select--open");
        }),
          i.forEach((e) => {
            e.addEventListener("click", () => {
              const n = e.innerHTML;
              (s.innerHTML = n),
                t.classList.remove("custom-select--open"),
                (t.dataset.value = e.dataset.value),
                i.forEach((e) =>
                  e.classList.remove("custom-select__option--selected"),
                ),
                e.classList.add("custom-select__option--selected");
            });
          }),
          document.addEventListener("click", (t) => {
            t.target.closest("[data-select]") ||
    ...
    document.addEventListener("DOMContentLoaded", () => {
      document.querySelectorAll(".product__switch-input").forEach((e) => {
        e.addEventListener("change", (e) => {
          const t = e.target.closest(".product__add"),
            s = document.querySelector(".product__price[data-base-price]"),
            i = t.querySelector("[data-price]");
          if (!s || !i) return;
          const n = parseInt(s.dataset.basePrice, 10),
            l = parseInt(i.dataset.price, 10);
          e.target.checked ? (s.textContent = n + l) : (s.textContent = n);
        });
      });
    }),
    document.addEventListener("DOMContentLoaded", () => {
      document.querySelectorAll(".rating").forEach((e) => {
        const t = ((parseFloat(e.dataset.rating) || 0) / 5) * 100,
          s = e.querySelector("span");
        s && (s.style.width = `${t}%`);
      });
    }),
    document.addEventListener("DOMContentLoaded", function () {
      document.querySelectorAll("[data-showmore]").forEach((e) => {
        const t = e.getAttribute("data-showmore").split(","),
          s = parseInt(t[0], 10),
          i = t[1] ? parseInt(t[1], 10) : null,
          n = () => {
            ...
            if (i && window.innerWidth > i) {
              ...
              t.length > s &&
              (t.slice(s).forEach((e) => (e.style.display = "none")),
              !e.nextElementSibling ||
                !e.nextElementSibling.classList.contains("showmore-wrapper"))
            ) {
              const i = document.createElement("div");
              i.classList.add("showmore-wrapper");
              const n = document.createElement("button");
              (n.textContent = "Показать еще"),
                n.classList.add("btn"),
                i.appendChild(n),
                e.insertAdjacentElement("afterend", i),
                n.addEventListener("click", () => {
                  t.slice(s).forEach((e) => (e.style.display = "")), i.remove();
                });
            }
          };
  ...
  let n = (e, t = 500, s = 0) => {
    ...
    a = (e, t = 500) => (e.hidden ? l(e, t) : n(e, t)),
    r = !0,
    o = (e = 0) => {
        ...
        if ("click" === s) {
          if (!n.disabled)
            if (
              ...
              this.setDisableAfterSelectsForSend(s), this.optionAction(i, n, e);
            }
        } else
      ...
      if (e < t.length)
        for (let s = e; s < t.length; s++) {
          ...
          e.setAttribute("disabled", "disabled"),
            ...
            (e.closest(".select").querySelector(".select__content").innerHTML =
              e[0].innerHTML);
        }
    }
    selectsСlose() {
    ...
    for (let i = 1; i < arguments.length; i += 1) {
      ...
      if (
        ...
        for (let t = 0, i = s.length; t < i; t += 1) {
          const i = s[t],
            l = Object.getOwnPropertyDescriptor(n, i);
          void 0 !== l &&
            l.enumerable &&
            (C(e[i]) && C(n[i])
              ? n[i].__swiper__
  ...
  const q = (e, t) => {
    ...
    H = (e) => {
      ...
      if (e.params.rewind || e.params.loop)
        for (let i = n - t; i <= l + t; i += 1) {
          const t = ((i % s) + s) % s;
          (t < n || t > l) && V(e, t);
        }
      else
        for (let i = Math.max(n - t, 0); i <= Math.min(l + t, s - 1); i += 1)
          i !== n && (i > l || i < n) && V(e, i);
    };
  var N = {
    updateSize: function () {
    ...
    updateSlides: function () {
      ...
      const i = e.params,
        ...
        p = I(l, `.${e.params.slideClass}, swiper-slide`),
      ...
      for (let n = 0; n < u; n += 1) {
        ...
        if (
          ((L = 0),
          p[n] && (l = p[n]),
          T && e.grid.updateSlide(n, l, u, t),
          !p[n] || "none" !== O(l, "display"))
        ) {
          if ("auto" === i.slidesPerView) {
            ...
            if (
              ...
              if (o && "border-box" === o) L = e + n + r;
                ...
                const { clientWidth: s, offsetWidth: a } = l;
                L = e + t + i + n + r + (a - s);
              }
            }
            ...
            (L = (a - (i.slidesPerView - 1) * w) / i.slidesPerView),
              i.roundLengths && (L = Math.floor(L)),
      ...
      if (
        ...
        x(n, "--swiper-centered-offset-before", -h[0] + "px"),
          x(
            n,
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        const c =
            ...
            (o.swiperSlideSize + r),
          p =
            (a - l[0] + (s.centeredSlides ? t.minTranslate() : 0) - d) /
            (o.swiperSlideSize + r),
          u = -(a - d),
    ...
    updateProgress: function (e) {
      ...
      let { progress: n, isBeginning: l, isEnd: a, progressLoop: r } = t;
      const o = l,
        d = a;
      if (0 === i) (n = 0), (l = !0), (a = !0);
      else {
    ...
    updateSlidesClasses: function () {
      const e = this,
        ...
        a = (e) => I(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
      let r;
      if (
        (t.forEach((e) => {
          e.classList.remove(
    ...
    updateActiveIndex: function (e) {
      ...
      if ((o >= i.length && (o = i.length - 1), d === l))
        return (
  ...
  var j = {
    ...
    setTranslate: function (e, t) {
      const s = this,
        { rtlTranslate: i, params: n, wrapperEl: l, progress: a } = s;
      let r,
        o = 0,
        d = 0;
      s.isHorizontal() ? (o = i ? -e : e) : (d = e),
        ...
        n.cssMode
          ...
          : n.virtualTranslate ||
            ...
            (l.style.transform = `translate3d(${o}px, ${d}px, 0px)`));
      ...
      if (
        ...
        if (0 === t) r[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!l.support.smoothScroll)
            return (
              T({ swiper: l, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
  ...
  var W = {
    slideTo: function (e, t, s, i, n) {
      ...
      if ((l.animating && r.preventInteractionOnTransition) || (!g && !i && !n))
        return !1;
      const m = Math.min(l.params.slidesPerGroupSkip, a);
      let f = m + Math.floor((a - m) / l.params.slidesPerGroup);
      ...
      let y;
      if (
        (a !== (c || 0) && s && l.emit("beforeSlideChangeStart"),
        l.updateProgress(v),
      ...
      if (r.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!l.support.smoothScroll)
            return (
              T({ swiper: l, targetPosition: s, side: e ? "left" : "top" }), !0
            );
    ...
    slideNext: function (e, t, s) {
      ...
      const i = this,
        { enabled: n, params: l, animating: a } = i;
      if (!n) return i;
    ...
    slidePrev: function (e, t, s) {
      ...
      const u = p(r ? i.translate : -i.translate),
        h = l.map((e) => p(e));
      let g = l[h.indexOf(u) - 1];
      if (void 0 === g && n.cssMode) {
        let e;
        l.forEach((t, s) => {
          u >= t && (e = s);
        }),
          void 0 !== e && (g = l[e > 0 ? e - 1 : e]);
      }
      let m = 0;
      if (
        (void 0 !== g &&
        ...
        (n = parseInt(
          ...
          t.centeredSlides
            ? l < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (l = e.getSlideIndex(
                  I(s, `${a}[data-swiper-slide-index="${n}"]`)[0],
                )),
                b(() => {
                  e.slideTo(l);
                }))
  ...
  var Y = {
    loopCreate: function (e) {
      ...
      I(i, `.${s.slideClass}, swiper-slide`).forEach((e, t) => {
    ...
    loopFix: function (e) {
      ...
      let S = 0,
        C = 0;
      if (l < m) {
        S = Math.max(m - l, h.slidesPerGroup);
        for (let e = 0; e < m - l; e += 1) {
          const t = e - Math.floor(e / d.length) * d.length;
          f.push(d.length - t - 1);
        }
      } else if (l > o.slides.length - 2 * m) {
        C = Math.max(l - (o.slides.length - 2 * m), h.slidesPerGroup);
        for (let e = 0; e < C; e += 1) {
          const t = e - Math.floor(e / d.length) * d.length;
          v.push(t);
        }
  ...
  function X(e) {
    const t = this,
      ...
      n = t.touchEventsData;
    n.evCache.push(e);
    const { params: l, touches: a, enabled: r } = t;
    if (!r) return;
    ...
    const C = S && t.allowTouchMove && l.touchStartPreventDefault;
  ...
  function U(e) {
    ...
    i.isMoved &&
      ...
      S &&
      Math.abs(m) >= 1 &&
      (s.loopFix({ direction: s.swipeDirection, setTranslate: !0 }), (C = !0)),
      s.emit("sliderMove", o),
      (i.isMoved = !0),
  ...
  function K(e) {
    ...
    for (
      ...
      void 0 !== r[e + t]
        ? u >= r[e] && u < r[e + t] && ((h = e), (g = r[e + t] - r[e]))
        : u >= r[e] && ((h = e), (g = r[r.length - 1] - r[r.length - 2]));
    }
    let m = null,
      f = null;
    n.rewind &&
  ...
  const ie = (e, t) => {
    const s = f(),
      { params: i, el: n, wrapperEl: l, device: a } = e,
      r = !!i.nested,
  ...
  const re = {
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const r = (a in l ? l[a] : void 0) || e.originalParams,
            o = ne(e, i),
            d = ne(e, r),
            c = i.enabled;
          o && !d
      ...
      classes: {
        addClasses: function () {
          const e = this,
            { classNames: t, params: s, rtl: i, el: n, device: l } = e,
            a = (function (e, t) {
              const s = [];
              return (
                e.forEach((e) => {
  ...
  class de {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = P(I(t, `.${s.slideClass}, swiper-slide`)[0]);
      return P(e) - i;
    }
    ...
    mount(e) {
      ...
      return (
        !n &&
          ...
          ((n = _("div", t.params.wrapperClass)),
          s.append(n),
          I(s, `.${t.params.slideClass}`).forEach((e) => {
            n.append(e);
          })),
        Object.assign(t, {
          el: s,
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((n) => {
          if (!s[n] && !0 === s.auto) {
            let l = I(e.el, `.${i[n]}`)[0];
            l || ((l = _("div", i[n])), (l.className = i[n]), e.el.append(l)),
              (s[n] = l),
              (t[n] = l);
          }
        }),
  ...
  function he(e) {
    ...
    function p(e) {
      ...
      if (t.params.loop) {
        ...
        if (s > t.slides.length - t.loopedSlides) l(s > n ? "next" : "prev");
      ...
      p.forEach((e, l) => {
        ...
        "custom" === s.type && s.renderCustom
          ? ((e.innerHTML = s.renderCustom(t, i + 1, h)),
            0 === l && n("paginationRender", e))
          : (0 === l && n("paginationRender", e), n("paginationUpdate", e)),
          t.params.watchOverflow &&
            t.enabled &&
    ...
    i("changeDirection", () => {
      ...
      i("init", () => {
        !1 === t.params.pagination.enabled ? f() : (g(), h(), u());
      }),
      i("activeIndexChange", () => {
  ...
  function ge(e) {
    let t,
      s,
      { swiper: i, extendParams: n, on: l, emit: a, params: r } = e;
    ...
    const w = () => {
        ...
        const e = i.autoplay.paused ? o : y + v - new Date().getTime();
      ...
      S = (e) => {
        ...
        (m = i.params.autoplay.delay), (v = i.params.autoplay.delay);
        const l = (() => {
          let e;
          if (
            ((e =
      ...
      C = () => {
        (i.autoplay.running = !0), S(), a("autoplayStart");
      },
      E = () => {
      ...
      L = () => {
        if (i.destroyed || !i.autoplay.running) return;
        const e = f();
        "hidden" === e.visibilityState && ((g = !0), x(!0)),
          "visible" === e.visibilityState && T();
      },
      I = (e) => {
        "mouse" === e.pointerType &&
          ((g = !0), i.animating || i.autoplay.paused || x(!0));
      },
      _ = (e) => {
    ...
    l("init", () => {
      i.params.autoplay.enabled &&
        (i.params.autoplay.pauseOnMouseEnter &&
          (i.el.addEventListener("pointerenter", I),
          i.el.addEventListener("pointerleave", _)),
        f().addEventListener("visibilitychange", L),
        (y = new Date().getTime()),
        C());
    }),
      l("destroy", () => {
        i.el.removeEventListener("pointerenter", I),
          i.el.removeEventListener("pointerleave", _),
      ...
      Object.assign(i.autoplay, { start: C, stop: E, pause: x, resume: T });
  }
  function me(e, t) {
    const s = L(t);
    return (
  ...
  window.addEventListener("load", function (e) {
    ye(),
      ...
      document.querySelector(".product__carousels") &&
        new de(".main-carousel__slider", {
          ...
          speed: 800,
          loop: !0,
          pagination: { el: ".main-carousel__pagination", clickable: !0 },
          on: {},
        }),
      document.querySelector(".carousel--1") &&
        new de(".carousel--1 .carousel__slider", {
          ...
          spaceBetween: 20,
          speed: 800,
          pagination: { el: ".carousel--1 .pagination", clickable: !0 },
          navigation: {
      ...
      document.querySelector(".carousel--new") &&
        new de(".carousel--new .carousel__slider", {
          modules: [pe, he],
          slidesPerView: 4,
          spaceBetween: 20,
          speed: 800,
          pagination: { el: ".carousel--new .pagination", clickable: !0 },
          navigation: {
      ...
      document.querySelector(".reviews-all__slider") &&
        new de(".reviews-all__slider", {
          modules: [pe, ge],
      ...
      document.querySelector(".info__slider") &&
        new de(".info__slider", {
          ...
          breakpoints: {
            ...
            768: { slidesPerView: 3, centeredSlides: !1, spaceBetween: 20 },
            992: { slidesPerView: 4 },
            1366: { slidesPerView: 4 },
          },
          on: {},
  ...
  var je = function (e, t, s, i) {
      ...
      if (n) {
        var l = n.split(",");
        if (l[1])
          for (var a = window.innerWidth, r = 0; r < l.length; r++) {
            var o = l[r];
            if (parseInt(o.split("-")[2], 10) > a) {
              n = o;
              break;
            }
            r === l.length - 1 && (n = o);
    ...
    Ye = function (e, t, s, i, n, l) {
      var a =
        ...
        r = "";
      l &&
        (r = ("string" == typeof l ? JSON.parse(l) : l).map(function (e) {
          var t = "";
          return (
      ...
      var n = [],
        l = (function () {
          ...
          var i = Array(e),
            n = 0;
          for (t = 0; t < s; t++)
            for (var l = arguments[t], a = 0, r = l.length; a < r; a++, n++)
              i[n] = l[a];
          return i;
        })(He, t);
      return (
        [].forEach.call(e, function (e) {
          for (var t = {}, a = 0; a < e.attributes.length; a++) {
            ...
            if (r.specified) {
              var o = Ne(r.name),
                d = "";
              l.indexOf(o) > -1 && (d = o), d && (t[d] = r.value);
            }
          }
          var c = Ve(e),
      ...
      return (
        ...
        (e.prototype.hideScrollbar = function () {
          if (this.shouldHideScrollbar()) {
            this.bodyPaddingRight = parseFloat(Ve("body").style().paddingRight);
        ...
        (e.prototype.openGallery = function (e, t) {
          ...
          if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (l = Re(t, this.outer, r, o, this.currentImageSize))),
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, s, i, n) {
          var l = this,
            ...
            r = n && "video" === this.getSlideType(a) && !a.poster ? i : 0;
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            if (m) {
              ...
              C = Ke(l, E || "", g, this.settings.strings.playVideo, h);
              n.prepend(C);
            } else if (h) {
              C = '<div class="lg-video-cont " style="' + g + '"></div>';
              n.prepend(C);
            } else if ((this.setImgMarkup(d, n, e), a || o)) {
          ...
          var T = 0;
          v && !Ve(document.body).hasClass("lg-from-hash") && (T = v),
            this.isFirstSlideWithZoomAnimation() &&
              (setTimeout(function () {
                n.removeClass(
            ...
            (this.isFirstSlideWithZoomAnimation() &&
              ...
              this.onLgObjectLoad(n, e, v, T, f, !(!h || !h.html5 || l)),
            (this.zoomFromOrigin && this.currentImageSize) ||
        ...
        (e.prototype.getItemsToBeInsertedToDom = function (e, t, s) {
          ...
          if (e < (this.galleryItems.length - 1) / 2) {
            for (var r = e; r > e - l / 2 && r >= 0; r--)
              n.push("lg-item-" + this.lgId + "-" + r);
            var o = n.length;
            for (r = 0; r < l - o; r++)
              n.push("lg-item-" + this.lgId + "-" + (e + r + 1));
          } else {
            for (r = e; r <= this.galleryItems.length - 1 && r < e + l / 2; r++)
              n.push("lg-item-" + this.lgId + "-" + r);
            for (o = n.length, r = 0; r < l - o; r++)
              n.push("lg-item-" + this.lgId + "-" + (e - r - 1));
          }
          return (
            this.settings.loop &&
          ...
          "lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"),
            setTimeout(function () {
              ...
              if (
                ...
                var r = Ve(s.target);
                n.isPosterElement(r) && n.LGel.trigger(Ae);
              }
        ...
        (e.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            Ve(window).on("mousemove.lg.global" + this.lgId, function (l) {
              i &&
                e.lgOpened &&
                ((n = !0),
            ...
            Ve(window).on("mouseup.lg.global" + this.lgId, function (l) {
              if (e.lgOpened) {
                var a = Ve(l.target);
                n
        ...
        (e.prototype.destroyGallery = function () {
          this.destroyModules(!0),
            this.settings.dynamic || this.invalidateItems(),
            Ve(window).off(".lg.global" + this.lgId),
            this.LGel.off(".lg"),
  ...
  (window.FLS = !0),
    (function () {
      ...
      const t = document.querySelector(".menu__body"),
          ...
          e.addEventListener("click", function (e) {
            if (
              ...
              document
                ...
                .forEach((e) => e.classList.remove("submenu-open"));
            }
          }),
        s.addEventListener("click", () => {
