...
(() => {
  ...
  t &&
    ...
    (function () {
      const e = document.querySelector(".search__btn"),
        t = document.querySelector(".search");
      e &&
        t &&
        e.addEventListener("click", () => {
          t.classList.toggle("search_active");
        });
    })();
  let s = (e, t = 500, s = 0) => {
  ...
  var V = {
    ...
    updateSlides: function () {
      ...
      for (let n = 0; n < u; n += 1) {
        ...
        if (
          ((A = 0),
          p[n] && (a = p[n]),
          I && e.grid.updateSlide(n, a, u, t),
          !p[n] || "none" !== L(a, "display"))
        ) {
          if ("auto" === i.slidesPerView) {
            ...
            if (
              ...
              A = e.isHorizontal() ? _(a, "width", !0) : _(a, "height", !0);
            else {
              const e = s(l, "width"),
                t = s(l, "padding-left"),
                i = s(l, "padding-right"),
            ...
            (A = (l - (i.slidesPerView - 1) * w) / i.slidesPerView),
              i.roundLengths && (A = Math.floor(A)),
      ...
      if (
        ...
        I && e.grid.updateWrapperSize(A, h, t),
        !i.centeredSlides)
      ) {
        const t = [];
    ...
    updateSlidesClasses: function () {
      const e = this,
        ...
        l = (e) => T(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
      let r;
      if (
        (t.forEach((e) => {
          e.classList.remove(
        ...
        (n = parseInt(
          ...
          t.centeredSlides
            ? a < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (a = e.getSlideIndex(
                  T(s, `${l}[data-swiper-slide-index="${n}"]`)[0],
                )),
                v(() => {
                  e.slideTo(a);
                }))
  ...
  var R = {
    ...
    loopFix: function (e) {
      ...
      let S = 0,
        C = 0;
      if (a < g) {
        S = Math.max(g - a, h.slidesPerGroup);
        for (let e = 0; e < g - a; e += 1) {
          const t = e - Math.floor(e / d.length) * d.length;
          f.push(d.length - t - 1);
        }
      } else if (a > o.slides.length - 2 * g) {
        C = Math.max(a - (o.slides.length - 2 * g), h.slidesPerGroup);
        for (let e = 0; e < C; e += 1) {
          const t = e - Math.floor(e / d.length) * d.length;
          v.push(t);
        }
  ...
  function X(e) {
    ...
    if (p > n.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (b >= n.longSwipesRatio
          ? t.slideTo(n.rewind && t.isEnd ? g : h + w)
          : t.slideTo(h)),
        "prev" === t.swipeDirection &&
          (b > 1 - n.longSwipesRatio
            ? t.slideTo(h + w)
            : null !== f && b < 0 && Math.abs(b) > n.longSwipesRatio
            ? t.slideTo(f)
            : t.slideTo(h));
    } else {
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const p = r.direction && r.direction !== i.direction,
            ...
            h = i.loop;
          p && s && e.changeDirection(), S(e.params, r);
  ...
  class re {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = A(T(t, `.${s.slideClass}, swiper-slide`)[0]);
      return A(e) - i;
    }
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((n) => {
          if (!s[n] && !0 === s.auto) {
            let a = T(e.el, `.${i[n]}`)[0];
            a || ((a = I("div", i[n])), (a.className = i[n]), e.el.append(a)),
              (s[n] = a),
              (t[n] = a);
          }
        }),
  ...
  function pe(e) {
    ...
    function u() {
      ...
      if (
        ...
        if (
          (s.dynamicBullets &&
            ((l = _(n[0], t.isHorizontal() ? "width" : "height", !0)),
            p.forEach((e) => {
    ...
    i("changeDirection", () => {
      ...
      i("init", () => {
        !1 === t.params.pagination.enabled ? f() : (m(), h(), u());
      }),
      i("activeIndexChange", () => {
  ...
  function ue(e) {
    ...
    a("init", () => {
      i.params.autoplay.enabled &&
        ...
        m().addEventListener("visibilitychange", I),
        (y = new Date().getTime()),
        C());
    }),
      a("destroy", () => {
        i.el.removeEventListener("pointerenter", L),
          ...
          m().removeEventListener("visibilitychange", I),
              ...
              i = () => {
                const i =
                  "string" == typeof e.swiper
                    ...
                    : e.swiper;
                if (i && i.swiper) (e.swiper = i.swiper), r(), o(!0);
                else if (i) {
                  const s = (n) => {
                    (e.swiper = n.detail[0]),
  ...
  const ye = (e, t, s, i) => {
    ...
    const a = function () {
      return e.matches
        ? (console.log("da"), (n = new re(t, s)), void (i && i(n)))
        : void 0 !== n
  ...
  window.addEventListener("load", function (e) {
    !(function () {
      if (
        ...
        ye("(max-width: 1280px)", ".why-we__slider", {
          modules: [pe],
          slidesPerView: 1,
          speed: 800,
        ...
        ye("(max-width: 768px)", ".desc__slider", {
          modules: [pe],
          slidesPerView: 1,
          autoHeight: !0,
          speed: 800,
        ...
        ye("(max-width: 768px)", ".connect__slider", {
          modules: [pe],
          slidesPerView: 1,
          spaceBetween: 20,
          speed: 800,
        ...
        const e = new re(".thumbs-carousel__slider", {
          modules: [de, he],
          direction: "vertical",
          slidesPerView: 5,
          spaceBetween: 10,
      ...
      document.querySelector(".carousel--1") &&
        new re(".carousel--1 .carousel__slider", {
          modules: [de],
          slidesPerView: 6,
          spaceBetween: 20,
          speed: 800,
        ...
        document.querySelector(".carousel--2") &&
          new re(".carousel--2 .carousel__slider", {
            modules: [de],
            slidesPerView: 6,
            spaceBetween: 20,
            speed: 800,
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            if (g) {
              ...
              C = Ke(a, E || "", m, this.settings.strings.playVideo, h);
              n.prepend(C);
            } else if (h) {
          ...
          this.settings.enableDrag &&
            ...
            Ve(window).on("mouseup.lg.global" + this.lgId, function (a) {
              if (e.lgOpened) {
                var l = Ve(a.target);
                n
                  ? ((n = !1), e.touchEnd(s, t, a), e.LGel.trigger($e))
                  : e.isPosterElement(l) && e.LGel.trigger(Pe),
                  i &&
                    ((i = !1),
