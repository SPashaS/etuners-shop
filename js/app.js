...
(() => {
  "use strict";
  const t = {},
    e = document.querySelectorAll(".menu__toggle");
  e &&
    e.forEach((t) => {
      t.addEventListener("click", () => {
        const e = t.closest(".menu__item");
        document.querySelectorAll(".menu__item.submenu-open").forEach((t) => {
          t !== e && t.classList.remove("submenu-open");
        }),
          e && e.classList.toggle("submenu-open");
      });
    });
  const s = document.querySelector(".search__btn"),
    i = document.querySelector(".search");
  s &&
    i &&
    s.addEventListener("click", () => {
      i.classList.toggle("search_active");
    }),
    document.addEventListener("DOMContentLoaded", () => {
      const t = document.querySelectorAll("[data-select]");
      t.forEach((e) => {
        const s = e.querySelector("[data-select-trigger]"),
          i =
            (e.querySelector("[data-select-options]"),
            e.querySelectorAll(".custom-select__option"));
        s.addEventListener("click", (s) => {
          t.forEach((t) => {
            t !== e && t.classList.remove("custom-select--open");
          }),
            e.classList.toggle("custom-select--open");
        }),
          i.forEach((t) => {
            t.addEventListener("click", () => {
              const l = t.innerHTML;
              (s.innerHTML = l),
                e.classList.remove("custom-select--open"),
                (e.dataset.value = t.dataset.value),
                i.forEach((t) =>
                  t.classList.remove("custom-select__option--selected"),
                ),
                t.classList.add("custom-select__option--selected");
            });
          }),
          document.addEventListener("click", (e) => {
            e.target.closest("[data-select]") ||
              t.forEach((t) => t.classList.remove("custom-select--open"));
          });
      });
    }),
    document.addEventListener("DOMContentLoaded", () => {
      document.querySelectorAll(".product__switch-input").forEach((t) => {
        t.addEventListener("change", (t) => {
          const e = t.target.closest(".product__add"),
            s = document.querySelector(".product__price[data-base-price]"),
            i = e.querySelector("[data-price]");
          if (!s || !i) return;
          const l = parseInt(s.dataset.basePrice, 10),
            o = parseInt(i.dataset.price, 10);
          t.target.checked ? (s.textContent = l + o) : (s.textContent = l);
        });
      });
    }),
    document.addEventListener("DOMContentLoaded", () => {
      document.querySelectorAll(".rating").forEach((t) => {
        const e = ((parseFloat(t.dataset.rating) || 0) / 5) * 100,
          s = t.querySelector("span");
        s && (s.style.width = `${e}%`);
      });
    }),
    document.addEventListener("DOMContentLoaded", function () {
      document.querySelectorAll("[data-showmore]").forEach((t) => {
        const e = t.getAttribute("data-showmore").split(","),
          s = parseInt(e[0], 10),
          i = e[1] ? parseInt(e[1], 10) : null,
          l = () => {
            const e = Array.from(t.children);
            if (i && window.innerWidth > i) {
              e.forEach((t) => (t.style.display = ""));
              const s = t.nextElementSibling;
              s && s.classList.contains("showmore-wrapper") && s.remove();
            } else if (
              e.length > s &&
              (e.slice(s).forEach((t) => (t.style.display = "none")),
              !t.nextElementSibling ||
                !t.nextElementSibling.classList.contains("showmore-wrapper"))
            ) {
              const i = document.createElement("div");
              i.classList.add("showmore-wrapper");
              const l = document.createElement("button");
              (l.textContent = "Показать еще"),
                l.classList.add("btn"),
                i.appendChild(l),
                t.insertAdjacentElement("afterend", i),
                l.addEventListener("click", () => {
                  e.slice(s).forEach((t) => (t.style.display = "")), i.remove();
                });
            }
          };
  ...
  let l = (t, e = 500, s = 0) => {
    ...
    n = (t, e = 500) => (t.hidden ? o(t, e) : l(t, e)),
    r = !0,
    a = (t = 0) => {
  ...
  t.popup = new (class {
    ...
    popupLogging(t) {
      this.options.logging && d(`[Попапос]: ${t}`);
    }
  })({});
  let g = {
    getErrors(t) {
    ...
    addError(t) {
      t.classList.add("_form-error"),
        t.closest(".form__row").classList.add("_form-error");
  ...
  t.select = new (class {
          ...
          if (!l.disabled)
            if (
              ...
              const t = e.closest(
                ...
                s = t.closest(".select").dataset.id;
              this.setDisableAfterSelectsForSend(s), this.optionAction(i, l, t);
            }
        } else
    ...
    setDisableAfterSelectsForSend(t) {
      const e = document.querySelectorAll(".filter__select");
      if (t < e.length)
        for (let s = t; s < e.length; s++) {
          const t = e[s];
          t.setAttribute("disabled", "disabled"),
            t.closest(".select").classList.add("_select-disabled"),
            (t.closest(".select").querySelector(".select__content").innerHTML =
              t[0].innerHTML);
        }
    }
    selectsСlose() {
    ...
    getSelectElementContent(t) {
      ...
      let i = "";
      return (
        (i += e ? `<span class="${this.selectClasses.classSelectRow}">` : ""),
        (i += e ? `<span class="${this.selectClasses.classSelectData}">` : ""),
        (i += e ? s : ""),
        (i += e ? "</span>" : ""),
        (i += e ? `<span class="${this.selectClasses.classSelectText}">` : ""),
        (i += t.textContent),
        (i += e ? "</span>" : ""),
        (i += e ? "</span>" : ""),
        i
    ...
    getSelectPlaceholder(t) {
      ...
      if (e)
        return {
          ...
          label: { show: e.hasAttribute("data-label"), text: e.dataset.label },
        };
    }
    ...
    getOptions(t) {
      let e = t.hasAttribute("data-scroll") ? "data-simplebar" : "",
        s = t.dataset.scroll ? `style="max-height:${t.dataset.scroll}px"` : "",
    ...
    getOption(t, e) {
      const s =
          t.selected && e.multiple
            ...
            : "",
        i = t.selected && !e.hasAttribute("data-show-selected") ? "hidden" : "",
        l = t.dataset.class ? ` ${t.dataset.class}` : "",
        o = !!t.dataset.href && t.dataset.href,
        n = t.hasAttribute("data-href-blank") ? 'target="_blank"' : "";
      let r = "";
      return (
        (r += o
          ? `<a ${n} ${i} href="${o}" data-value="${t.value}" class="${this.selectClasses.classSelectOption}${l}${s}">`
          : `<button ${i} class="${this.selectClasses.classSelectOption}${l}${s}" data-value="${t.value}" type="button">`),
    ...
    setSelectChange(t) {
      if (
        ...
        (e.type = "submit"), t.closest("form").append(e), e.click(), e.remove();
      }
      const e = t.parentElement;
    ...
    setLogging(t) {
      this.config.logging && d(`[select]: ${t}`);
    }
  })({});
  var u = function () {
    return (
  ...
  var p = "lgAfterAppendSlide",
    m = "lgInit",
    f = "lgHasVideo",
    y = "lgContainerResize",
    v = "lgUpdateSlides",
    b = "lgAfterAppendSubHtml",
    S = "lgBeforeOpen",
    C = "lgAfterOpen",
    w = "lgSlideItemLoad",
    E = "lgBeforeSlide",
  ...
  var P = (function () {
    ...
    return (
      ...
      (t.prototype.find = function (t) {
        return M(this._getSelector(t, this.selector));
      }),
  ...
  var B = function (t, e, s, i) {
      void 0 === s && (s = 0);
      var l = M(t).attr("data-lg-size") || i;
      if (l) {
        var o = l.split(",");
        if (o[1])
          for (var n = window.innerWidth, r = 0; r < o.length; r++) {
            var a = o[r];
    ...
    H = function (t, e, s, i, l) {
      if (l) {
        var o = M(t).find("img").first();
        if (o.get()) {
          var n = e.get().getBoundingClientRect(),
            r = n.width,
            a = e.height() - (s + i),
            c = o.width(),
            d = o.height(),
    ...
    V = function (t) {
      for (var e = [], s = [], i = "", l = 0; l < t.length; l++) {
        var o = t[l].split(" ");
        "" === o[0] && o.splice(0, 1), s.push(o[0]), e.push(o[1]);
      }
      for (var n = window.innerWidth, r = 0; r < e.length; r++)
      ...
      var l = [],
        o = (function () {
          ...
          var i = Array(t),
            l = 0;
          for (e = 0; e < s; e++)
            for (var o = arguments[e], n = 0, r = o.length; n < r; n++, l++)
              i[l] = o[n];
          return i;
        })(q, e);
      return (
        [].forEach.call(t, function (t) {
          for (var e = {}, n = 0; n < t.attributes.length; n++) {
            ...
            if (r.specified) {
              var a = z(r.name),
                c = "";
              o.indexOf(a) > -1 && (c = a), c && (e[c] = r.value);
            }
          }
          var d = M(t),
    ...
    Y = function (t, e, s) {
      ...
      return i ? { youtube: i } : l ? { vimeo: l } : o ? { wistia: o } : void 0;
    },
    X = 0,
    K = (function () {
      function t(t, e) {
      ...
      return (
        (t.prototype.generateSettings = function (t) {
          if (
            ...
            var e = u(
              u({}, this.settings.mobileSettings),
              this.settings.mobileSettings,
            );
            this.settings = u(u({}, this.settings), e);
          }
        }),
        ...
        (t.prototype.init = function () {
          ...
          this.addSlideVideoInfo(this.galleryItems),
            this.buildStructure(),
            this.LGel.trigger(m, { instance: this }),
            ...
            var t = this,
              e = function (e) {
                var i = s.items[e],
                  l = M(i),
                  o = P.generateUUID();
                l.attr("data-lg-id", o).on(
                  "click.lgcustom-item-" + o,
                  function (s) {
                    s.preventDefault();
                    var l = t.settings.index || e;
                    t.openGallery(l, i);
                  },
                );
              },
        ...
        (t.prototype.getSlideItem = function (t) {
          return M(this.getSlideItemId(t));
        }),
          ...
          if (!(this.$container && this.$container.get())) {
            ...
            var l = this.settings.ariaLabelledby
              ...
              c =
                ...
                "\n                </div>\n            </div>\n        </div>\n        ";
            M(this.settings.container).append(c),
              document.body !== this.settings.container &&
                M(this.settings.container).css("position", "relative"),
          ...
          if ("this" === this.settings.selector) this.items.push(this.el);
            ...
            if ("string" == typeof this.settings.selector)
              if (this.settings.selectWithin) {
                var t = M(this.settings.selectWithin);
        ...
        (t.prototype.hideScrollbar = function () {
          if (this.shouldHideScrollbar()) {
            this.bodyPaddingRight = parseFloat(M("body").style().paddingRight);
            ...
            M(document.body).css(
              ...
              M(document.body).addClass("lg-overlay-open");
          }
        }),
        (t.prototype.resetScrollBar = function () {
          this.shouldHideScrollbar() &&
            ...
            M(document.body).removeClass("lg-overlay-open"));
        }),
        (t.prototype.openGallery = function (t, e) {
          ...
          if ((void 0 === t && (t = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (o = H(e, this.outer, r, a, this.currentImageSize))),
        ...
        (t.prototype.addHtml = function (t) {
            ...
            if (e) {
              ...
              ("." !== i && "#" !== i) ||
                (e =
                  ...
                  !this.settings.dynamic
                    ? M(this.items).eq(t).find(e).first().html()
                    : M(e).first().html());
            } else e = "";
          if (".lg-item" !== this.settings.appendSubHtmlTo)
            ...
            var l = M(this.getSlideItemId(t));
            s
              ? l.load(s)
              : l.append('<div class="lg-sub-html">' + e + "</div>");
          }
          null != e &&
            ("" === e
              ? this.outer
        ...
        (t.prototype.getDummyImageContent = function (t, e, s) {
          var i;
          if ((this.settings.dynamic || (i = M(this.items).eq(e)), i)) {
            var l = void 0;
            if (
          ...
          var i = this.galleryItems[s],
            ...
            c =
              ...
              (this.isFirstSlideWithZoomAnimation()
                ? this.getDummyImageContent(e, s, a)
                : F(s, t, a, o, n, r)) +
              "</picture>";
          e.prepend(c);
        }),
        ...
        (t.prototype.onLgObjectLoad = function (t, e, s, i, l, o) {
          var n = this;
          this.onSlideObjectLoad(
            t,
            o,
            function () {
              n.triggerSlideItemLoad(t, e, s, i, l);
            },
            function () {
        ...
        (t.prototype.triggerSlideItemLoad = function (t, e, s, i, l) {
          var o = this,
            n = this.galleryItems[e],
            r = l && "video" === this.getSlideType(n) && !n.poster ? i : 0;
          setTimeout(function () {
            t.addClass("lg-complete lg-complete_"),
              o.LGel.trigger(w, { index: e, delay: s || 0, isFirstSlide: l });
          }, r);
        }),
        ...
        (t.prototype.addSlideVideoInfo = function (t) {
          ...
          t.forEach(function (t, s) {
            (t.__slideVideoInfo = Y(t.src, !!t.video, s)),
              t.__slideVideoInfo &&
        ...
        (t.prototype.loadContent = function (t, e) {
          ...
          if (
            ...
            if (y) {
              ...
              v &&
                this.zoomFromOrigin &&
                this.currentImageSize &&
                (x = this.getDummyImageContent(l, t, ""));
              I = j(o, x || "", m, this.settings.strings.playVideo, u);
              l.prepend(I);
            } else if (u) {
              I = '<div class="lg-video-cont " style="' + m + '"></div>';
              l.prepend(I);
            } else if ((this.setImgMarkup(c, l, t), n || a)) {
              var L = l.find(".lg-object");
          ...
          var O = 0;
          b && !M(document.body).hasClass("lg-from-hash") && (O = b),
            this.isFirstSlideWithZoomAnimation() &&
              (setTimeout(function () {
                l.removeClass(
              ...
              l.hasClass("lg-loaded") ||
                setTimeout(function () {
                  ...
                  ("image" === s.getSlideType(i) ||
                    ...
                    (s.onLgObjectLoad(l, t, b, O, !0, !1),
                    s.onSlideObjectLoad(
                      l,
                      !(!u || !u.html5 || o),
                      function () {
                        s.loadContentOnFirstSlideLoad(t, l, O);
                      },
                      function () {
                        s.loadContentOnFirstSlideLoad(t, l, O);
                      },
            ...
            (this.isFirstSlideWithZoomAnimation() &&
              ...
              this.onLgObjectLoad(l, t, b, O, v, !(!u || !u.html5 || o)),
            (this.zoomFromOrigin && this.currentImageSize) ||
        ...
        (t.prototype.getItemsToBeInsertedToDom = function (t, e, s) {
          ...
          var n = "lg-item-" + this.lgId + "-" + e;
          if (this.galleryItems.length <= 3)
            return (
              this.galleryItems.forEach(function (t, e) {
                l.push("lg-item-" + i.lgId + "-" + e);
              }),
              l
            );
          if (t < (this.galleryItems.length - 1) / 2) {
            ...
            var a = l.length;
            for (r = 0; r < o - a; r++)
              l.push("lg-item-" + this.lgId + "-" + (t + r + 1));
          } else {
            for (r = t; r <= this.galleryItems.length - 1 && r < t + o / 2; r++)
              l.push("lg-item-" + this.lgId + "-" + r);
            for (a = l.length, r = 0; r < o - a; r++)
              l.push("lg-item-" + this.lgId + "-" + (t - r - 1));
          }
          return (
            this.settings.loop &&
            ...
            -1 === l.indexOf(n) && l.push("lg-item-" + this.lgId + "-" + e),
            l
          );
        }),
            ...
            setTimeout(
              function () {
                i.outer.addClass("lg-no-trans"),
                  ...
                  "prev" === t
                    ? (e.addClass("lg-prev-slide"), s.addClass("lg-next-slide"))
            ...
            if (!this.lgBusy) {
              ...
              this.lGalleryOn
                ? setTimeout(
                    function () {
                      l.loadContent(t, !0),
                        ".lg-item" !== l.settings.appendSubHtmlTo &&
                          l.addHtml(t);
                    },
                    this.settings.speed +
                      50 +
          ...
          "lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"),
            setTimeout(function () {
              ...
              if ("horizontal" === l.swipeDirection) {
                ...
                i < 0 && n > l.settings.swipeThreshold
                  ? (l.goToNextSlide(!0), (o = !1))
                  : i > 0 &&
                    n > l.settings.swipeThreshold &&
                    (l.goToPrevSlide(!0), (o = !1));
              ...
              if (
                ...
                var r = M(s.target);
                l.isPosterElement(r) && l.LGel.trigger(x);
              }
          ...
          this.settings.enableSwipe &&
            (this.$inner.on("touchstart.lg", function (s) {
              ...
              (!M(s.target).hasClass("lg-item") &&
                ...
                (t.touchAction = "swipe"),
                t.manageSwipeClass(),
                (e = { pageX: s.touches[0].pageX, pageY: s.touches[0].pageY }));
            }),
            ...
            this.$inner.on("touchend.lg", function (o) {
              if ("swipe" === t.touchAction) {
                if (i) (i = !1), t.touchEnd(s, e, o);
                else if (l) {
                  var n = M(o.target);
                  t.isPosterElement(n) && t.LGel.trigger(x);
                }
                (t.touchAction = void 0), (l = !1);
              }
            }));
        }),
        (t.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            (this.outer.on("mousedown.lg", function (s) {
              t.dragOrSwipeEnabled = !0;
              var l = t.getSlideItem(t.index);
              (M(s.target).hasClass("lg-item") || l.get().contains(s.target)) &&
                (t.outer.hasClass("lg-zoomed") ||
                  t.lgBusy ||
                  (s.preventDefault(),
                  t.lgBusy ||
            ...
            M(window).on("mousemove.lg.global" + this.lgId, function (o) {
              i &&
                t.lgOpened &&
                ((l = !0),
            ...
            M(window).on("mouseup.lg.global" + this.lgId, function (o) {
              if (t.lgOpened) {
                var n = M(o.target);
                l
                  ? ((l = !1), t.touchEnd(s, e, o), t.LGel.trigger(_))
                  : t.isPosterElement(n) && t.LGel.trigger(x),
                  i &&
                    ((i = !1),
        ...
        (t.prototype.goToPrevSlide = function (t) {
          ...
          t && this.galleryItems.length < 3 && (s = !1),
            this.lgBusy ||
              (this.index > 0
                ? (this.index--,
                  this.LGel.trigger(T, { index: this.index, fromTouch: t }),
        ...
        (t.prototype.keyPress = function () {
          var t = this;
          M(window).on("keydown.lg.global" + this.lgId, function (e) {
            t.lgOpened &&
              !0 === t.settings.escKey &&
              27 === e.keyCode &&
              (e.preventDefault(),
        ...
        (t.prototype.setTranslate = function (t, e, s, i, l) {
          void 0 === i && (i = 1),
            void 0 === l && (l = 1),
            t.css(
              "transform",
        ...
        (t.prototype.closeGallery = function (t) {
          ...
          this.LGel.trigger($),
            this.settings.resetScrollPosition &&
              !this.settings.hideScrollbar &&
              M(window).scrollTop(this.prevScrollTop);
          var s,
          ...
          if (this.zoomFromOrigin && i) {
            var l = this.mediaContainerPosition,
              ...
              c = r.poster,
              d = B(i, this.outer, o + n, a && c && this.settings.videoMaxSize);
            s = H(i, this.outer, o, n, d);
          }
          ...
          return (
            ...
            setTimeout(function () {
              e.zoomFromOrigin &&
                ...
                e.$inner.empty(),
                e.lgOpened && e.LGel.trigger(D, { instance: e }),
        ...
        (t.prototype.destroyGallery = function () {
          this.destroyModules(!0),
            this.settings.dynamic || this.invalidateItems(),
            M(window).off(".lg.global" + this.lgId),
            this.LGel.off(".lg"),
  ...
  if (J.length) {
    ...
    J.forEach((t) => {
      e.push({
        gallery: t,
        galleryClass: Z(t, {
          selector: ".main-carousel__slide-ibg",
  ...
  (window.FLS = !0),
        ...
        t &&
          t.addEventListener("click", function (t) {
            if (
              ...
              document
                .querySelectorAll(".menu__item.submenu-open")
                .forEach((t) => t.classList.remove("submenu-open"));
            }
          }),
        s.addEventListener("click", () => {
                ...
                i.length &&
                  ...
                  i.forEach((t, i) => {
                    s[i].setAttribute("data-tabs-title", ""),
                      ...
                      o && i == e[1] && s[i].classList.add("_tab-active"),
      ...
      function s(t, e) {
        t.forEach((t) => {
          let s = (t = t.item).querySelector("[data-tabs-titles]"),
            ...
            l = t.querySelector("[data-tabs-body]"),
          ...
          (i = Array.from(i).filter((e) => e.closest("[data-tabs]") === t)),
            ...
            o.forEach((o, n) => {
              e.matches
                ? (l.append(i[n]), l.append(o), t.classList.add("_tab-spoller"))
                : (s.append(i[n]), t.classList.remove("_tab-spoller"));
            });
        });
      }
      function i(t) {
      ...
      function n(t) {
        ...
        if (e.closest("[data-tabs-title]")) {
          ...
          if (
            ...
            let t = l.querySelectorAll("[data-tabs-title]._tab-active");
            t.length &&
              (t = Array.from(t).filter((t) => t.closest("[data-tabs]") === l)),
    ...
    document.addEventListener("click", function (t) {
      ...
      if (e.closest(".quantity__button")) {
        let t = parseInt(e.closest(".quantity").querySelector("input").value);
