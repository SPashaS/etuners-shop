...
export function menuInit() {
  ...
  menuBody.insertAdjacentElement('afterend', overlay);
  ...
  overlay.addEventListener('click', () => {
    ...
    const openSubmenus = document.querySelectorAll('.menu__item.submenu-open');
    openSubmenus.forEach((submenu) => submenu.classList.remove('submenu-open'));
  });
}
